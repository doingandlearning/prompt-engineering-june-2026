---
name: create-prd
description: Generate a Product Requirements Document (PRD) in Markdown format based on an initial prompt
metadata:
  version: 1.0
...
- You have access to browsermcp
- When you get stuck, feel free to use @Web to search documentation for support
